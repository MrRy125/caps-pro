...
const UserManagementPage = () => {
  ...
  const [users, setUsers] = useState([
    { id: 1, name: 'John Doe', email: 'john.doe@agritech.gov', password: '••••••••', role: 'Admin', status: 'Active', avatar: 'JD' },
    { id: 2, name: 'Maria Santos', email: 'maria.santos@agritech.gov', password: '••••••••', role: 'MAO Staff', status: 'Active', avatar: 'MS' },
    { id: 3, name: 'Carlos Reyes', email: 'carlos.reyes@agritech.gov', password: '••••••••', role: 'MAO Staff', status: 'Inactive', avatar: 'CR' },
    { id: 4, name: 'Ana Lim', email: 'ana.lim@agritech.gov', password: '••••••••', role: 'MAO Staff', status: 'Active', avatar: 'AL' },
    { id: 5, name: 'Roberto Cruz', email: 'roberto.cruz@agritech.gov', password: '••••••••', role: 'MAO Staff', status: 'Active', avatar: 'RC' },
    { id: 6, name: 'Lisa Wang', email: 'lisa.wang@agritech.gov', password: '••••••••', role: 'Admin', status: 'Active', avatar: 'LW' },
    { id: 7, name: 'Miguel Torres', email: 'miguel.torres@agritech.gov', password: '••••••••', role: 'MAO Staff', status: 'Inactive', avatar: 'MT' },
    { id: 8, name: 'Sarah Kim', email: 'sarah.kim@agritech.gov', password: '••••••••', role: 'MAO Staff', status: 'Active', avatar: 'SK' }
  ]);

  const [newUser, setNewUser] = useState({
    name: '', email: '', password: '', role: 'MAO Staff', status: 'Active'
  });
  ...
  const handleAddUser = () => {
    ...
    setNewUser({ name: '', email: '', password: '', role: 'MAO Staff', status: 'Active' });
              ...
              <TableBody>
                {paginatedUsers.map((user) => (
                  <TableRow key={user.id} className="border-t border-[#333333] hover:bg-[#252525]">
                    ...
                    <TableCell className="text-gray-400 font-mono">{user.role}</TableCell>
                    <TableCell>
